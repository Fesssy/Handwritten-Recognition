...
model.save('handwrittenRecognitionModel.keras')
model.save('handwrittenRecognitionModel2.h5')
model_final.save('handwrittenRecognitionModel_final.keras')
model_final.save('handwrittenRecognitionModel_final2.h5')
